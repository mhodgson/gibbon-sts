...
Gem::Specification.new do |s|
  ...
  s.authors = [%q{Jaakko Suutarla}]
  s.date = %q{2011-05-27}
  s.description = %q{Gibbon STS is a simple API wrapper for interacting with MailChimp STS API 1.0. It just a fork from the wonderful Gibbon(https://github.com/amro/gibbon)}
  ...
  s.homepage = %q{http://github.com/jaakkos/gibbon-sts}
  s.licenses = [%q{MIT}]
